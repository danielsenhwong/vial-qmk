...
// Add unique Vial keyboard ID
#define VIAL_KEYBOARD_UID {0x19, 0xA6, 0x00, 0x52, 0x06, 0xFE, 0x63, 0x7C}
// Vial secure unlock is grave (`) + enter
// (i.e., top left and bottom right key on left half of the keyboard)
...
#define RGB_DEAULT_HUE 116
#define RGB_DEAULT_SAT 255
#define RGB_DEAULT_VAL 36
